import {infoId33,lastCar,sortCarModels,allTheYears,olderThan3000,bmwAndAudi} from "./solution.js";
let inventory = [
  ...
  console.log(olderThan3000(allTheYears(inventory)).length+" cars are older then 2000");
  // ==== Problem #6 ====
